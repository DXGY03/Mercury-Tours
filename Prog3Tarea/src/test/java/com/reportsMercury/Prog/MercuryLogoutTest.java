...
public class MercuryLogoutTest {
	...
	//Localizadores del Log Out
	By logoutBtnLocator = By.linkText("SIGN-OFF");
	...
	public void logoutTest() 
	{
		...
		assertEquals("SIGN-ON", driver.findElement(loginBtnLocator).getText());
	}
}
